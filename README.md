...
A python script to capture images triggered by motion , external trigger or manually. Uses Raspberry OS BULLSEYE or BOOKWORM) (fro BOOKWORM switch to X11 not Wayland) and libcamera-vid.
